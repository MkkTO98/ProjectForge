...
## Role
Run project initialization. Ask extensive setup questions. Create state, decisions, tasks, agents, skills, templates, and permissions for the generated project.
